...
export const INTERVIEW_MESSAGES = {
  ...
  APPLICATION_NOT_ELIGIBLE:
    "Application is not eligible for scheduling interviews. It must be ACTIVE",
  INTERVIEWER_CONFLICT:
    "Interviewer scheduling conflict detected. One or more interviewers are already booked at this time",
  DUPLICATE_ROUND:
    "An active interview of the same round is already scheduled for this application",
  ...
  TIME_VALIDATION_ERROR:
    "Start time must be before end time and scheduled date cannot be in the past",
};
