...
export const updateOfferSchema = z
  .object({
    salary: z.coerce
      .number()
      .positive("Salary must be a positive number greater than zero")
      .optional(),
    ...
    offerLetterUrl: z
      .string()
      .trim()
      .url("Invalid offer letter URL")
      .max(2048, "Offer letter URL cannot exceed 2048 characters")
      .optional()
      .nullable(),
    offerLetterFileName: normalizedString(
      500,
      "Offer letter filename cannot exceed 500 characters"
    ),
  })
  .refine(
    (data) => {
