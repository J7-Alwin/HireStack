...
export const candidateController = {
  createCandidate: async (req: Request, res: Response): Promise<void> => {
    ...
    const result = await candidateService.createCandidate(
      parsedBody as unknown as CandidateCreateInput,
      currentUser
    );

    res
      .status(HTTP_STATUS.CREATED)
      .json(successResponse(CANDIDATES_MESSAGES.CANDIDATE_CREATED, result));
  },
  ...
  getCandidateById: async (req: Request, res: Response): Promise<void> => {
    ...
    res
      ...
      .json(successResponse(CANDIDATES_MESSAGES.CANDIDATE_RETRIEVED, result));
  },
  ...
  updateCandidate: async (req: Request, res: Response): Promise<void> => {
    ...
    const result = await candidateService.updateCandidate(
      id,
      parsedBody as unknown as CandidateUpdateInput,
      currentUser
    );

    res.status(HTTP_STATUS.OK).json(successResponse(CANDIDATES_MESSAGES.CANDIDATE_UPDATED, result));
  },
  ...
  softDeleteCandidate: async (req: Request, res: Response): Promise<void> => {
    ...
    res.status(HTTP_STATUS.OK).json(successResponse(CANDIDATES_MESSAGES.CANDIDATE_DELETED, result));
  },
  ...
  restoreCandidate: async (req: Request, res: Response): Promise<void> => {
    ...
    res
      .status(HTTP_STATUS.OK)
      .json(successResponse(CANDIDATES_MESSAGES.CANDIDATE_RESTORED, result));
  },
  ...
  listCandidates: async (req: Request, res: Response): Promise<void> => {
    ...
    const result = await candidateService.listCandidates(
      parsedQuery as unknown as CandidateQueryFilters,
      currentUser
    );

    res
      .status(HTTP_STATUS.OK)
      .json(paginationResponse(CANDIDATES_MESSAGES.CANDIDATES_RETRIEVED, result.data, result.meta));
  },
  ...
  addSkill: async (req: Request, res: Response): Promise<void> => {
    ...
    const result = await candidateService.addSkill(
      id,
      parsedBody as unknown as CandidateSkillInput,
      currentUser
    );

    res.status(HTTP_STATUS.OK).json(successResponse("Skill assigned successfully", result));
  },
  ...
  updateSkill: async (req: Request, res: Response): Promise<void> => {
    ...
    const result = await candidateService.updateSkill(
      id,
      skillId,
      parsedBody as unknown as Omit<CandidateSkillInput, "skillId">,
      currentUser
    );

    res
      .status(HTTP_STATUS.OK)
      .json(successResponse("Skill proficiency updated successfully", result));
  },
  ...
  removeSkill: async (req: Request, res: Response): Promise<void> => {
    ...
    res.status(HTTP_STATUS.OK).json(successResponse("Skill removed successfully", result));
  },
  ...
  addEducation: async (req: Request, res: Response): Promise<void> => {
    ...
    const result = await candidateService.addEducation(
      id,
      parsedBody as unknown as CandidateEducationInput,
      currentUser
    );

    res.status(HTTP_STATUS.OK).json(successResponse("Education record added successfully", result));
  },
  ...
  updateEducation: async (req: Request, res: Response): Promise<void> => {
    ...
    const result = await candidateService.updateEducation(
      id,
      educationId,
      parsedBody as unknown as Partial<CandidateEducationInput>,
      currentUser
    );

    res
      .status(HTTP_STATUS.OK)
      .json(successResponse("Education record updated successfully", result));
  },
  ...
  deleteEducation: async (req: Request, res: Response): Promise<void> => {
    ...
    res
      .status(HTTP_STATUS.OK)
      .json(successResponse("Education record deleted successfully", result));
  },
  ...
  addExperience: async (req: Request, res: Response): Promise<void> => {
    ...
    const result = await candidateService.addExperience(
      id,
      parsedBody as unknown as CandidateExperienceInput,
      currentUser
    );

    res
      .status(HTTP_STATUS.OK)
      .json(successResponse("Experience record added successfully", result));
  },
  ...
  updateExperience: async (req: Request, res: Response): Promise<void> => {
    ...
    const result = await candidateService.updateExperience(
      id,
      experienceId,
      parsedBody as unknown as Partial<CandidateExperienceInput>,
      currentUser
    );

    res
      .status(HTTP_STATUS.OK)
      .json(successResponse("Experience record updated successfully", result));
  },
  ...
  deleteExperience: async (req: Request, res: Response): Promise<void> => {
    ...
    res
      .status(HTTP_STATUS.OK)
      .json(successResponse("Experience record deleted successfully", result));
  },
  ...
  addDocument: async (req: Request, res: Response): Promise<void> => {
    ...
    const result = await candidateService.addDocument(
      id,
      parsedBody as unknown as CandidateDocumentInput,
      currentUser
    );

    res.status(HTTP_STATUS.OK).json(successResponse("Document registered successfully", result));
  },
  ...
  deleteDocument: async (req: Request, res: Response): Promise<void> => {
    ...
    res.status(HTTP_STATUS.OK).json(successResponse("Document removed successfully", result));
  },
  ...
  addNote: async (req: Request, res: Response): Promise<void> => {
    ...
    const result = await candidateService.addNote(
      id,
      parsedBody as unknown as CandidateNoteInput,
      currentUser
    );

    res.status(HTTP_STATUS.CREATED).json(successResponse("Note added successfully", result));
  },
  ...
  updateNote: async (req: Request, res: Response): Promise<void> => {
    ...
    const parsedBody = candidateNoteSchema.parse(req.body);
    const result = await candidateService.updateNote(
      id,
      noteId,
      parsedBody as unknown as CandidateNoteInput,
      currentUser
    ...
    res.status(HTTP_STATUS.OK).json(successResponse("Note updated successfully", result));
  },
  ...
  deleteNote: async (req: Request, res: Response): Promise<void> => {
    ...
    res.status(HTTP_STATUS.OK).json(successResponse("Note deleted successfully", result));
  },
  ...
  assignTag: async (req: Request, res: Response): Promise<void> => {
    ...
    res.status(HTTP_STATUS.OK).json(successResponse("Tag assigned successfully", result));
  },
  ...
  removeTag: async (req: Request, res: Response): Promise<void> => {
    ...
    res.status(HTTP_STATUS.OK).json(successResponse("Tag removed successfully", result));
  },
};
