...
import { DepartmentQueryFilters, DepartmentCreateInput, DepartmentUpdateInput } from "./departments.types";
...
export const departmentsController = {
  createDepartment: async (req: Request, res: Response): Promise<void> => {
    ...
    res.status(HTTP_STATUS.CREATED).json(
      successResponse(DEPARTMENTS_MESSAGES.DEPARTMENT_CREATED, department)
    );
  },
  ...
  getDepartmentById: async (req: Request, res: Response): Promise<void> => {
    ...
    res.status(HTTP_STATUS.OK).json(
      successResponse(DEPARTMENTS_MESSAGES.DEPARTMENT_RETRIEVED, department)
    );
  },
  ...
  updateDepartment: async (req: Request, res: Response): Promise<void> => {
    ...
    res.status(HTTP_STATUS.OK).json(
      successResponse(DEPARTMENTS_MESSAGES.DEPARTMENT_UPDATED, department)
    );
  },
  ...
  changeStatus: async (req: Request, res: Response): Promise<void> => {
    ...
    res.status(HTTP_STATUS.OK).json(
      successResponse(DEPARTMENTS_MESSAGES.STATUS_UPDATED, department)
    );
  },
  ...
  softDelete: async (req: Request, res: Response): Promise<void> => {
    ...
    res.status(HTTP_STATUS.OK).json(
      successResponse(DEPARTMENTS_MESSAGES.DEPARTMENT_DELETED, department)
    );
  },
  ...
  restore: async (req: Request, res: Response): Promise<void> => {
    ...
    res.status(HTTP_STATUS.OK).json(
      successResponse(DEPARTMENTS_MESSAGES.DEPARTMENT_RESTORED, department)
    );
  },
};
