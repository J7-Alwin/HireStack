...
-- ResumeRecommendationMode enum removed from sync migration (moved to add_resume_recommendations)
...
-- ResumeRecommendation table removed from sync migration (moved to add_resume_recommendations)
...
-- ResumeRecommendation indexes removed from sync migration
...
-- ResumeRecommendation foreign keys removed from sync migration
